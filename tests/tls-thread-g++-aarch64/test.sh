...
aarch64-linux-gnu-g++-10 -fPIC -c -o lib.o lib.cc
aarch64-linux-gnu-g++-10 -lpthread -Wl,--hash-style=gnu -shared -Wl,-soname,lib.so -o lib.so lib.o
aarch64-linux-gnu-g++-10 -Wl,--hash-style=gnu -o main main.cc lib.so -lpthread
